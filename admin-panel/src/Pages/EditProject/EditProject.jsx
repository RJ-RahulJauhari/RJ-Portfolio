...
const EditProject = () => {
  ...
  const getProject = async () => {
    try {
      await axios.get(`${BASE_URL}/projects/get/${id}`)
      .then((res) => {
        const data = res.data;
        if(data){
          console.log(data);
  ...
  const updateProject = async () => {
    ...
    try {
      await axios.patch(`${BASE_URL}/projects/update/${id}`,obj,{withCredentials:true})
        .then((res) => {
          const data = res.data;
          if(data){
            console.log(data)
  ...
  return (
    ...
    <div className='bottom-buttons'>
        ...
        <button className='submit-btn' onClick={() => (updateProject())}>Submit</button>
    </div>
