...
server.use(cors({ origin: ['https://rahuljauhari.onrender.com','https://rj-portfolio-admin-panel.onrender.com','https://rj-portfolio-api-rahul-jauharis-projects.vercel.app','http://localhost:3000', 'http://localhost:3001'], credentials: true }))
