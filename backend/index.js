...
server.use(cors({ origin: ['https://rj-rahul-jauhari-portfolio-chj1pd3hm-rahul-jauharis-projects.vercel.app','http://localhost:3000' , 'http://localhost:3001'], credentials: true }))
